...
import { DEFAULT_MODEL_ID, getModelRegistryEntry } from "@/config/modelRegistry";
...
import {
  extractOutline, extractTextByPageRange,
  ...
  useEffect(() => {
    ...
    (async () => {
      for (const idx of nextPending) {
        ...
        if (current?.status === "pending") await analyzeChapter(idx);
      }
