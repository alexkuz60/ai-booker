    ...
    return (
      <div className="flex gap-2 px-3 py-1.5 group">
        ...
        <textarea
          ...
          className="flex-1 text-sm font-body text-foreground bg-background border border-primary/30 rounded px-2 py-1 resize-none focus:outline-none focus:ring-1 focus:ring-primary" style={{ lineHeight: '1.5' }}
        />
    ...
    <ContextMenu>
      <ContextMenuTrigger asChild>
        <div onContextMenu={handleContextMenu} className="flex gap-2 px-3 py-0.5 hover:bg-accent/20 transition-colors group">
          ...
          <p ref={textRef} className="text-sm font-body text-foreground flex-1 select-text" style={{ lineHeight: '1.5' }}>
