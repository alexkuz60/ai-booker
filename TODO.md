...
- [ ] **Чекбоксы «Готово» для глав, профайлов, персонажей** — защита от случайной перезаписи AI-анализом: глава/профайл/персонаж помеченные «Готово» блокируются от пакетных операций (re-segmentation, re-profiling), статус хранится в OPFS
