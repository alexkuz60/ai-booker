...
**Утилита одноразовой миграции (сохранена):**
- `migrateMirrorTranslation.ts` — переносит данные из legacy зеркал в подпапки. Вызывается только кнопкой в OPFS Browser (админка).
